 ...
 * pixel idiom with the display face (Geist Pixel Grid, see Arrow below), which
 * is the reason it is built on a grid at all rather than as curves.
 *
...
function Mark({ className = "" }: { className?: string }) {
  return (
    /* crispEdges because the whole point is square pixels: at the nav's 16px a
       grid cell is 1.33px, and the default antialiasing would soften every edge
       into a grey fringe. */
    <svg
      viewBox="0 0 12 12"
      aria-hidden
